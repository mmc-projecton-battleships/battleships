...
{
	//#devnote: add :check if difficulty is legit. if not, ask the player to re-enter difficulty level
...
void screen_end(char win)
{
	if (win=='w')
	{
		//#devnote:ending winner screen.
		//#devnote:request the player to hit "reset".
	}
	else if(win=='l')
	{
		//#devnote:ending winner screen.
